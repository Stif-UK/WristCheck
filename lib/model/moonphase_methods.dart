...
class MoonPhaseMethods {
  ...
  static Widget buildMoonWidget(DateTime date, double size) {
    return CustomMoonWidget(date: date, size: size);
  }
}
...
class CustomMoonWidget extends StatelessWidget {
  ...
  const CustomMoonWidget({super.key, required this.date, required this.size});
