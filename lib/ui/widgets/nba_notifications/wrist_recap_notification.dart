...
class WristRecapNotification extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
   ...
   _navigateAndDismiss() {
    ...
    // Perform navigation BEFORE dismissing the notification.
    // Calling dismissRecapNotification immediately removes this widget from the tree (via Obx in WristCheckHome),
    // which can interrupt the navigation process or invalidate the context.
